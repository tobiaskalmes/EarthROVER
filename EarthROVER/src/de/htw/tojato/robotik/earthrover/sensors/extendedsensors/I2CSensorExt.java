 ...
 */
public class I2CSensorExt implements SensorConstants {
    ...
    public I2CSensorExt(NXTCommand nxtCommand, I2CPort port) {
        this(nxtCommand, port, DEFAULT_I2C_ADDRESS, I2CPort.LEGO_MODE, TYPE_LOWSPEED);
    }
     ...
     */
    public I2CSensorExt(NXTCommand nxtCommand, I2CPort port, int mode) {
        this(nxtCommand, port, DEFAULT_I2C_ADDRESS, mode, TYPE_LOWSPEED);
    }
     ...
     * @param type
     */
    public I2CSensorExt(NXTCommand nxtCommand, I2CPort port, int address, int mode, int type) {
        ...
        try {
            this.nxtCommand.LSGetStatus(this.port);
            this.nxtCommand.LSRead(this.port);
        }
