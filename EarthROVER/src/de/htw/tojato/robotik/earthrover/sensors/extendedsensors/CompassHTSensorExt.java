 ...
 */
public class CompassHTSensorExt extends I2CSensorExt implements DirectionFinder {
    byte[] buf = new byte[2];
     ...
     */
    public CompassHTSensorExt(NXTCommand nxtCommand, I2CPort port, int address) {
        super(nxtCommand, port, address, I2CPort.LEGO_MODE, TYPE_LOWSPEED);
    }
     ...
     * @param port Sensor port for the compass
     */
    public CompassHTSensorExt(NXTCommand nxtCommand, I2CPort port) {
        this(nxtCommand, port, DEFAULT_I2C_ADDRESS);
    }
