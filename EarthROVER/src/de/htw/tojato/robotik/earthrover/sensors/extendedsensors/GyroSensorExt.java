 ...
 */
public class GyroSensorExt implements SensorConstants, Gyroscope {
    /**
     ...
     */
    public GyroSensorExt(ADSensorPort port) {
        this.port = port;
     ...
     * @see lejos.nxt.SensorPort
     */
    public GyroSensorExt(ADSensorPort port, int offset) {
        this(port);
        this.offset = offset;
    }
